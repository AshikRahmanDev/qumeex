...
export const Banner = () => {
  return (
    <div className='xl:w-[1200px] w-[90%] mx-auto flex flex-col-reverse md:flex-row justify-center md:justify-between items-center min-h-[90vh]'>
        ...
        <div data-aos="fade-left" className='mt-5 md:mt-0'>
